 ...
 */
package dev.panda.crates.utils.compatibility.sound;
...
public enum CompatibleSound {
    ...
    public Sound getSound() {
        if (ServerUtil.SERVER_VERSION_INT <= 8) {
            return this.sound8 == null ? Sound.valueOf("IRONGOLEM_DEATH") : Sound.valueOf(this.sound8);
        }
        if (ServerUtil.SERVER_VERSION_INT < 13) {
            return this.sound912 == null ? Sound.valueOf("ENTITY_IRONGOLEM_DEATH") : Sound.valueOf(this.sound912);
        }
        if (ServerUtil.SERVER_VERSION_INT >= 14) {
            return this.sound13 == null ? Sound.valueOf("ENTITY_IRON_GOLEM_DEATH") : Sound.valueOf(this.sound13);
        }
        return null;
    }
    ...
    public static CompatibleSound getSound(String name) {
        ...
        for (CompatibleSound sound : CompatibleSound.values()) {
            if (!(sound.sound8 != null && sound.sound8.equalsIgnoreCase(name) || sound.sound912 != null && sound.sound912.equalsIgnoreCase(name)) && (sound.sound13 == null || !sound.sound13.equalsIgnoreCase(name))) continue;
            return sound;
        }
        return null;
    }
